...
<template>
  <div class="goods-cart">
        ...
        <Transition name="list">
          <div class="goods-stop" v-if="shopItem.goodsList.length">
            <div class="goods-stop-title">
              <HCheckbox
                v-model:value="shopItem.isCheck"
                theme="pink"
                @callBack="shopToggle"
              >
            ...
            <TransitionGroup name="list">
              ...
              >
                <Transition>
                  ...
                  >
                    <h-icon name="icon-brush"></h-icon>
                  </div>
                </Transition>
                <HCheckbox
                  v-model:value="goodsItem.isCheck"
                  theme="pink"
                  @callBack="goodsToggle"
                >
                </HCheckbox>
    ...
    <div class="goods-cart-bottom flex-between">
      <HCheckbox
        :value="calc.isCheckAll"
        theme="pink"
        @callBack="checkAllToggle"
      >
